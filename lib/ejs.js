...
function includeSource(path, options) {
  ...
  template =  '<!-- ' + includePath + ' start -->' + fs.readFileSync(includePath).toString().replace(_BOM, '') + '<!-- ' + includePath + ' end -->';
...
if (require.extensions) {
  require.extensions['.ejs'] = function (module, filename) {
    ...
    var options = {
      ...
      , template =  '<!-- ' + filename + ' start -->' + fs.readFileSync(filename).toString()  + '<!-- ' + filename + ' end -->'
      , fn = exports.compile(template, options);
